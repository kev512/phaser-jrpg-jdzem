import { INITIAL_SPEED, MAX_FATIGUE, MAX_HUNGER, MAX_POOP, MAX_SPEED, MAX_STRESS, MAX_THIRST, MAX_URINE } from './consts/worker.consts';
...
export class Worker {
  ...
  applyEffect(effect: Effect) {
    this.hunger = Math.min(MAX_HUNGER, Math.max(0, this.hunger - effect.getEffectHuger()));
